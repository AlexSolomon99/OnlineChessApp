...
@views.route("/play_friend", methods=['POST', 'GET'])
...
@views.route("/game_table/<player_1>/<player_2>", methods=['POST', 'GET'])
...
@views.route("/join_w_code", methods=['POST', 'GET'])
def join_with_code():
    """
    ...
    if request.method == "POST":
        ...
        if not all_game_codes:
            ...
            return redirect(url_for("views.join_with_code"))
...
@views.route("/create_put_code", methods=['POST', 'GET'])
...
@views.route("/lobby", methods=['POST', 'GET'])
def lobby():
    """
    ...
    if request.method == "POST":
        if len(list_of_players_on_current_game) == 2:
            ...
            return redirect(url_for("views.game_table_page", player_1=player_1, player_2=player_2))
